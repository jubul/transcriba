...
Instancias de comportamiento abusivo, acosador o inaceptable de otro modo podrán ser reportadas a los administradores de la comunidad responsables del cumplimiento escribiendo a los mantenedores por los medios de contacto publicados en el perfil de GitHub de [@jubul](https://github.com/jubul); si el reporte requiere confidencialidad, también se puede usar el reporte privado de la pestaña **Security** del repositorio. Todas las quejas serán evaluadas e investigadas de una manera puntual y justa.
